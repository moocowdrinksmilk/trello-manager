    ...
    bot.hears("Hello", (ctx) =>
      fetch(
        ...
        .then((res) => {
          ...
          ctx.reply(
            `It is 12pm, and you have not completed these tasks that you are supposed to do. How do you feel about yourself? You better be doing them now or you are not going to get shit: \n\n ${str}`
          );
        })
    );
    bot.launch();
      ...
      fetch(
        ...
        .then((res) => {
          ...
          if (!res[0]) {
            bot.telegram.sendMessage(
              196032343,
              "Good Job, you have nothing left on your agenda. Do as you please."
            );
          } else {
            bot.telegram.sendMessage(
              196032343,
              `Wow are you serious? You still have shit left? You better finish it up or else you gon get ur ass whooped you piece of shit \n\n ${str}`
            );
          }
        });
      list.then((res) => {
